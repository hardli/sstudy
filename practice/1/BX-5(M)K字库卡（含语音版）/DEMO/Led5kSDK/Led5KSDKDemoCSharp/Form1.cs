...
namespace Led5KSDKDemoCSharp
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            type = t;
            uint hand = ONNONLed5KSDKD.Led5kSDK.CreateBroadCast(broad_ip, broad_port, (Led5kSDK.bx_5k_card_type)card_type_list[t]);
            m_dwCurHand = hand;
            if (hand == 0)
            {
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            type = t;
            uint hand = ONNONLed5KSDKD.Led5kSDK.CreateClient(led_ip, led_port, (Led5kSDK.bx_5k_card_type)card_type_list[t],1, null);
            m_dwCurHand = hand;
            if (hand == 0)
            {
                MessageBox.Show("连接控制器失败");
        ...
        private void button8_Click(object sender, EventArgs e)
        {
            ...
            uint hand = ONNONLed5KSDKD.Led5kSDK.CreateComClient(com, baudrate_list[bl], (Led5kSDK.bx_5k_card_type)card_type_list[t], ScreenID);
        ...
        {
            int err = ONNONLed5KSDKD.Led5kSDK.SCREEN_DelDynamicArea(m_dwCurHand, 2);
            if (err != 0)
            {
                MessageBox.Show("删除动态区失败");
            }
